...
export default function TemplatesModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-4xl max-h-[88vh] bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl flex flex-col overflow-hidden text-zinc-100">
        {/* Header */}
        <div className="p-6 border-b border-zinc-800/80 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white tracking-tight">Starter Templates Gallery</h2>
              <p className="text-xs text-zinc-400">Pick any production-ready interactive component to test or customize instantly</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Filter bar */}
        <div className="px-6 py-3.5 bg-zinc-950/60 border-b border-zinc-800/60 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          {/* Categories */}
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full bg-zinc-900 border border-zinc-800 rounded-lg pl-8 pr-3 py-1.5 text-xs text-white placeholder:text-zinc-500 focus:outline-none focus:border-indigo-500"
            />
          </div>
        </div>
          ...
          {filteredTemplates.map((template) => {
            ...
            return (
              <div
                ...
                className={`group cursor-pointer rounded-xl p-5 border text-left flex flex-col justify-between transition-all duration-200 ${
                  isSelected
              ...
              >
                ...
                <div className="mt-5 pt-3 border-t border-zinc-800/60 flex items-center justify-between text-xs">
